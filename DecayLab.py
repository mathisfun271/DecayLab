...
fig.savefig('/Users/nathanmihm/Math Graphics/Decay1.png',dpi=200)#Linear Save

plt.title('Computer Generated Decay of Candium (Logarithmic)')
ax.set_yscale('log')
fig.savefig('/Users/nathanmihm/Math Graphics/Decay2.png',dpi=200)#Logarithmic Save
